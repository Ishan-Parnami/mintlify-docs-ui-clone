...
This project is a desktop-first documentation-style website inspired by the Mintlify documentation platform. The objective of this assignment was to recreate the overall structure, layout, and content hierarchy of a modern documentation website using only HTML and CSS.
...
Fonts used in this project include Inter as the primary typeface with a sans-serif fallback.
...
Design inspiration taken from the Mintlify documentation website.  
Brand assets sourced from https://brandfetch.com/mintlify.com.  

This project was created strictly for educational and evaluation purposes.
